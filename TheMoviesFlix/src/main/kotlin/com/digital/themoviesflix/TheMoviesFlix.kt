...
class TheMoviesFlix : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/category/2160p-4k/" to "2160p 4K",
        "$mainUrl/category/60fps/" to "60FPS",
        "$mainUrl/category/blu-ray/" to "Blu-Ray",
        "$mainUrl/category/4k-ultra-hd/" to "4K Ultra HD",
        ...
        "$mainUrl/category/jio-studios/" to "Jio Studios",
        ...
        "$mainUrl/category/gujarati/" to "Gujarati",
